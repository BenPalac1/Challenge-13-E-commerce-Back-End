...
router.get('/', async (req, res) => {
  ...
  try {
    const productsAll = await Product.findAll({ include: [{ model: Category }, { model: Tag}],
    });
...
router.get('/:id', async (req, res) => {
  ...
  // be sure to include its associated Category and Tag data
  try {
    const productOne = await Product.findByPk(req.params.id, { include: [{ model: Category }, { model: Tag }],
    });
